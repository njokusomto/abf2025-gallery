    ...
    <>
      ...
      <main className="mx-auto max-w-[1960px] p-6 bg-black min-h-screen text-white">
        ...
        ">
          ...
          {/* HERO CARD — now spans TWO columns */}
          <motion.div
            className="
              relative 
              ...
              bg-gradient-to-b 
              from-[#1b3540] via-[#143140] to-[#122e3a] 
              p-10 text-center 
          ...
          {images.map(({ id, public_id, format, blurDataUrl }) => (
            <motion.div
              key={id}
              className="group relative block w-full cursor-zoom-in overflow-hidden rounded-2xl shadow-md transition-all duration-300 hover:shadow-2xl"
